...
define(['jquery', 'rest', 'utils'], function ($, rest, utils) {
    ...
    //prd：
    //$.get('http://api.uat.vveshow.com/interact/api/wechat/openid/hyx1927/packet');
    //debug
    /*
    ...
    switch (type) {
        default:
            ...
            appId = "57d640a10f93d57139243d6f";
            formId = "";
    ...
    function registerInfo(data) {
        ...
        rest.post(
            apiUrl + '/api/v1/{client}/{channel}/member/wechat/mobile/{mobile}/{code}',
